    ...
    <div className="min-h-screen pt-32 px-4 sm:px-6 lg:px-8 pb-24">
      <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {profile.interests.map((interest, index) => (
                <span
                  key={index}
                  className="px-4 py-2 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 hover:text-white transition-all duration-300 text-sm uppercase tracking-wider"
                >
                  {interest}
                </span>
              ))}
        ...
        <motion.div
          ...
          className="bg-gray-50 p-8 mb-16"
        >
          <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: 'var(--font-playfair)' }}>
            Get in Touch
          </h2>
          <div className="space-y-3">
            ...
            {profile?.phone && (
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${profile.phone}`} className="text-gray-700 hover:text-gray-900">
                  {profile.phone}
                </a>
              </div>
            )}
