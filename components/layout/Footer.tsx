    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="flex justify-center gap-8 mb-8">
          <Link
            href="/gallery"
            className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors uppercase tracking-wider"
          >
            Gallery
          </Link>
          <Link
        ...
        {(contactInfo.email || contactInfo.phone) && (
          <div className="flex justify-center gap-6 mb-8 text-sm">
            ...
            {contactInfo.phone && (
              <>
                {contactInfo.email && <span className="text-gray-300 dark:text-gray-700">•</span>}
                <a
